...
newUserBtn.addEventListener('click', ()=> {
    ...
    modalTitle.innerText = "Llene el formulario"
    isEdit = false
    imgInput.src = "../assets/IMG/Profile Icon.webp"
    form.reset()
})
...
function deleteInfo(index){
    if(confirm("Está seguro que quiere borrar al empleado?")){
...
form.addEventListener('submit', (e)=> {
    ...
    const information = {
        picture: imgInput.src == undefined ? "../assets/IMG/Profile Icon.webp" : imgInput.src,
    ...
    submitBtn.innerText = "Agregar"
    modalTitle.innerHTML = "Llene el formulario"
